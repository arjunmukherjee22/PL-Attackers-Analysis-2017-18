...
def draw_pitch(figure_width=900, figure_height=500, 
               pitch_width=150, pitch_height=68, 
...
def print_table(player_stats_df):
    ...
    data_table = DataTable(source=source,  columns=columns,  height=280, width=150, sizing_mode="stretch_width")
